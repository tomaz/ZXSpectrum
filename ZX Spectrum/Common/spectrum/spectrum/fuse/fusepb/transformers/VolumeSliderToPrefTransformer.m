/* VolumeSliderToPrefTransformer.h: A transformer that converts volume settings
   ...
   $Id: VolumeSliderToPrefTransformer.m,v 1.1 2005/04/18 02:55:20 fred Exp $
...
@implementation VolumeSliderToPrefTransformer
...
- (id)transformedValue:(id)value
{
  ...
  if ([value respondsToSelector: @selector(intValue)]) {
    volumeInputValue = [value intValue]; 
  } else {
