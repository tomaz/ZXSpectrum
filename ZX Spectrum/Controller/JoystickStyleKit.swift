...
public class JoystickStyleKit : NSObject {
    ...
    public dynamic class func drawJoystickBackground(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 250, height: 250), resizing: ResizingBehavior = .aspectFit) {
        ...
        //// Background Drawing
        let backgroundPath = UIBezierPath(ovalIn: CGRect(x: 1.5, y: 1.5, width: 248, height: 248))
        context.saveGState()
        backgroundPath.addClip()
        context.drawLinearGradient(joystickBackgroundGradient, start: CGPoint(x: 213.18, y: 213.18), end: CGPoint(x: 37.82, y: 37.82), options: [])
    ...
    public dynamic class func drawJoystickButton(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 160, height: 160), resizing: ResizingBehavior = .aspectFit) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
    ...
    public dynamic class func drawJoystickSmallButton(frame: CGRect = CGRect(x: 0, y: 0, width: 160, height: 75)) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Rectangle Drawing
        let rectanglePath = UIBezierPath(roundedRect: CGRect(x: frame.minX, y: frame.minY, width: frame.width, height: frame.height), cornerRadius: 8)
        context.saveGState()
        ...
        context.drawLinearGradient(joystickThumbGradient,
