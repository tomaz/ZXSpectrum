...
public class IconsStyleKit : NSObject {
    ...
    private struct Cache {
        ...
        static let iconBlenGradient: CGGradient = CGGradient(colorsSpace: nil, colors: [IconsStyleKit.sinclairBlackColor.cgColor, UIColor.clear.cgColor] as CFArray, locations: [0, 1])!
        static let cassetteCaseGradient: CGGradient = CGGradient(colorsSpace: nil, colors: [UIColor.red.cgColor, UIColor.red.cgColor] as CFArray, locations: [0, 1])!
        static let playerCaseGradient: CGGradient = CGGradient(colorsSpace: nil, colors: [UIColor.red.cgColor, UIColor.red.cgColor, UIColor.red.cgColor, UIColor.red.blended(withFraction: 0.5, of: UIColor.red).cgColor, UIColor.red.cgColor, UIColor.red.cgColor] as CFArray, locations: [0, 0.25, 0.47, 0.64, 0.78, 1])!
        static let playerTapeInlayGradient: CGGradient = CGGradient(colorsSpace: nil, colors: [UIColor.red.cgColor, UIColor.red.cgColor] as CFArray, locations: [0, 1])!
        static let playerTapeMetal: CGGradient = CGGradient(colorsSpace: nil, colors: [UIColor.red.cgColor, UIColor.red.blended(withFraction: 0.5, of: UIColor.red).cgColor, UIColor.red.cgColor] as CFArray, locations: [0, 0.52, 1])!
        static let screwOuterShadow: NSShadow = NSShadow(color: UIColor.white.withAlphaComponent(0.39), offset: CGSize(width: 0, height: 0), blurRadius: 3)
        static let cassetteHousingBottomShadow: NSShadow = NSShadow(color: UIColor.white.withAlphaComponent(0.09), offset: CGSize(width: 0, height: 0), blurRadius: 10)
        static let playerCaseShadow: NSShadow = NSShadow(color: UIColor.black, offset: CGSize(width: 0, height: 0), blurRadius: 50)
        static let playerSpeakerShadow: NSShadow = NSShadow(color: UIColor.black.withAlphaComponent(0.43), offset: CGSize(width: 0, height: 0), blurRadius: 20)
    ...
    public dynamic class var iconBlenGradient: CGGradient { return Cache.iconBlenGradient }
    public dynamic class var cassetteCaseGradient: CGGradient { return Cache.cassetteCaseGradient }
    public dynamic class var playerCaseGradient: CGGradient { return Cache.playerCaseGradient }
    public dynamic class var playerTapeInlayGradient: CGGradient { return Cache.playerTapeInlayGradient }
    public dynamic class var playerTapeMetal: CGGradient { return Cache.playerTapeMetal }

    //// Shadows

    public dynamic class var screwOuterShadow: NSShadow { return Cache.screwOuterShadow }
    public dynamic class var cassetteHousingBottomShadow: NSShadow { return Cache.cassetteHousingBottomShadow }
    public dynamic class var playerCaseShadow: NSShadow { return Cache.playerCaseShadow }
    public dynamic class var playerSpeakerShadow: NSShadow { return Cache.playerSpeakerShadow }
    ...
    public dynamic class func drawIconTape(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 22, height: 22), resizing: ResizingBehavior = .aspectFit) {
        ...
        //// Rectangle Drawing
        let rectanglePath = UIBezierPath(roundedRect: CGRect(x: 0.5, y: 0.5, width: 21, height: 21), cornerRadius: 1)
        UIColor.black.setStroke()
        ...
        rectangle2Path.move(to: CGPoint(x: 6, y: 21.5))
        rectangle2Path.addLine(to: CGPoint(x: 16, y: 21.5))
        rectangle2Path.addLine(to: CGPoint(x: 15.17, y: 18.5))
        rectangle2Path.addLine(to: CGPoint(x: 6.83, y: 18.5))
        rectangle2Path.addLine(to: CGPoint(x: 6, y: 21.5))
        ...
        //// Group
        //// Oval Drawing
        let ovalPath = UIBezierPath(ovalIn: CGRect(x: 4, y: 8, width: 5, height: 5))
        UIColor.black.setStroke()
        ovalPath.lineWidth = 1
        ovalPath.stroke()
        ...
        //// Oval 2 Drawing
        let oval2Path = UIBezierPath(ovalIn: CGRect(x: 13, y: 8, width: 5, height: 5))
        UIColor.black.setStroke()
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 6.86, y: 8))
        bezierPath.addLine(to: CGPoint(x: 15.14, y: 8))
        UIColor.black.setStroke()
        bezierPath.lineWidth = 1
        bezierPath.stroke()
        ...
        bezier2Path.move(to: CGPoint(x: 6.86, y: 13))
        bezier2Path.addLine(to: CGPoint(x: 15.14, y: 13))
        UIColor.black.setStroke()
